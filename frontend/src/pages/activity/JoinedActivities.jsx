    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
      ...
      <div className="relative bg-gradient-to-br from-amber-400 to-orange-600 pb-16 pt-12 px-4 sm:px-6 lg:px-8 overflow-hidden rounded-b-[2.5rem] shadow-2xl shadow-orange-500/20 mb-8">
        ...
        <div className="relative max-w-7xl mx-auto text-center z-10 mt-16">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight drop-shadow-sm">
            Activities <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-100 to-white">You've Joined</span>
          </h1>

          <p className="text-amber-50 max-w-2xl mx-auto text-lg leading-relaxed mb-8 font-medium">
            Track all the amazing experiences you're part of. Connect with fellow participants!
          </p>
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-2xl p-2 shadow-xl shadow-orange-900/5 flex flex-col md:flex-row gap-2">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search joined activities..."
            ...
            >
              <Zap className="w-4 h-4" /> Explore More
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-20">
        ...
        <div className="flex items-center justify-between mb-8 px-2">
          <div>
            <h2 className="text-2xl font-bold text-slate-800">Joined Activities</h2>
        ...
        {filteredActivities.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-2">
              {searchQuery ? 'No activities found' : 'No activities joined yet'}
            </h3>
            <p className="text-slate-500 mb-6">
              {searchQuery ? 'Try adjusting your search query' : 'Explore exciting activities and join your first one!'}
            </p>
            {searchQuery ? (
              <button
                  ...
                  <div className="h-56 relative overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 flex gap-2">
                      {isCancelled ? (
                        ...
                        <span className="px-2.5 py-1 rounded-full text-xs font-bold shadow-sm bg-emerald-500 text-white">
                          Joined ✓
                        </span>
                      )}
                    </div>
